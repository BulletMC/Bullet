...
class Player(
     ...
     * @param health The health of the boss bar, 0-1. It's possible to go over 1, and around 1.5 it'll start to show a second boss bar
     ...
     * @param createFog If the boss bar should create fog
     */
    fun updateBossBar(id: Int, action: ServerBossBarPacket.Action, title: String? = null, health: Float? = null, color: BossBarColor? = null, dividers: BossBarDividers? = null, darkenSky: Boolean? = null, playEndMusic: Boolean? = null, createFog: Boolean? = null) {
